(() => {
    ...
    let blogItems = document.querySelectorAll(".items-works__column");
    if (blogItems.length > 0) {
        let blogFilters = document.querySelectorAll(".items-works__title");
        if (blogFilters.length > 0) {
            for (let index = 0; index < blogFilters.length; index++) {
                ...
                blogFilter.addEventListener("click", (function(e) {
                    ...
                    const blogFilterActive = document.querySelector(".items-works__title.active");
                    blogFilterActive.classList.remove("active");
            ...
            function showBlogItems(filter) {
                for (let index = 0; index < blogItems.length; index++) {
                    ...
                    if ("all" === filter || !filter) blogItem.classList.remove("_hide"); else {
                        ...
                        if (blogItem.classList.contains("items-works__column_" + filter)) blogItem.classList.remove("_hide");
                    }
                }
            }
        }
